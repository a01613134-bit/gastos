...
st.image("gastos.jpg", caption="Predicción del costo de una actividad de una persona.")
...
datos =  pd.read_csv('datos_limpios_listos.csv', encoding='latin-1')
